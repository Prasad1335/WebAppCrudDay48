<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateUser.aspx.cs" Inherits="WebAppCrudDay48.Pages.Users.UpdateUser" %>
...
<body>
    <form id="form1" class="Createform" runat="server">
        ...
        <div>
            <table>
                 <thead><tr><th></th><th><p>Update User</p><hr/></th></tr></thead>
                <thead>
                    <tr>
                        <td>
                    ...
                    <td>
                        ...
                        <a style="float: right" href="DeafultUser.aspx"><input type="button" value="Back to Listing" /></a>
                    </td>
                </tr>
