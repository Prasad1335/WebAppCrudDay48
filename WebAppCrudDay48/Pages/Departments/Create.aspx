<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="WebAppCrudDay48.Pages.Departments.Create" %>
...
<body>
    ...
    <form id="form1" class="Createform" runat="server">
        ...
        <div>
            <table >
                 <thead><tr><th></th><th><p>Create New Department</p><hr/></th></tr></thead>
                <tr>
                    <td>
